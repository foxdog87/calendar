...
import com.example.calendar.components.NotificationPermissionButton
...
fun TaskCreateScreen(
    ...
    val recentTemplates by viewModel.recentTemplates.collectAsState() // ★ 追加
    ...
    TaskCreateContent(
        ...
        onDeleteTemplate = { template -> viewModel.deleteTemplate(template) }, // ★ 追加
